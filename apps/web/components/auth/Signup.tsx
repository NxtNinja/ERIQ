    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f0f2f0]">
      <div className="max-w-md w-full bg-white rounded-2xl border border-gray-300 shadow-md p-8">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-blue-700">Healthcare Portal Registration</h2>
          <p className="text-gray-500 text-sm mt-2">Join our hospital's patient portal</p>
        </div>
        ...
        <div className="mt-6 text-center text-gray-600">
          ...
          <Link href="/login" className="text-blue-600 font-semibold hover:underline transition">
            Log in
          </Link>
        </div>
      </div>
